...
(function (ShapeFlags) {
    ...
    ShapeFlags[ShapeFlags["TESXT_CHILDREN"] = 8] = "TESXT_CHILDREN";
...
var hostCreateElement = function (type) {
    console.log("hostCreateElement", type);
    var element = document.createElement(type);
    return element;
};
var hostSetElementText = function (el, text) {
    console.log("hostSetElementText", el, text);
    el.innerText = text;
};
var hostPatchProp = function (el, key, preValue, nextValue) {
...
var hostInsert = function (child, parent, anchor) {
...
function patchKeyedChildren(c1, c2, container) {
    ...
    while (i <= e1 && i <= e2) {
        ...
        if (!isSameVNodeType(prevChild, nextChild)) {
            console.log("两个 child 不相等（从左往右对比）");
            console.log("prevChild:" + prevChild);
            console.log("nextChild:" + nextChild);
            break;
        }
        console.log("两个 child 两等，接下来对比两个 child 节点（从左往右对比）");
    ...
    while (i <= e1 && i <= e2) {
        ...
        console.log("两个 child 相等，接下来对比两个 child 节点（从右向左对比）");
        patch(prevChild, nextChild, container);
        e1--;
        e2--;
    }
    if (i > e1 && i <= e2) {
        ...
        for (i = s1; i <= e1; i++) {
            ...
            newIndexToOldIndexMap[newIndex] = newIndex;
...
function setupStatefulComponent(instance) {
    ...
    var setupContext = instance.setup && instance.setup(instance.props);
...
function handleSetupResult(instance, setupResult) {
    ...
    finishCompoentSeteup(instance);
}
function finishCompoentSeteup(instance) {
